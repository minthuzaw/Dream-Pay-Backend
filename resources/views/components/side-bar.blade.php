    ...
    <div class="h-19.5">
        <p class="block px-8 py-6 m-0 text-size-sm whitespace-nowrap text-slate-700 bg-gradient-gray">
            <img src="{{asset('backend/logo/dream-pay-logo.png')}}"
                 class="inline transition-all duration-200 ease-nav-brand max-h-32" alt="main_logo" style="width: 4rem; height: 4rem"/>
        ...
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                   href="{{ route('admins-management.index') }}">
                    <div
                        class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <i class="fas fa-building" style="color: #080707"></i>
                    </div>
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Admins Management</span>
                </a>
            </li>
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                   href="{{ route('users-management.index') }}">
                    <div
                        class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <i class="fas fa-users" style="color: #080707"></i>
                    </div>
...
{{--                 style="background-image: {{asset('backend/img/curved-images/white-curved.jpeg')}}"></div>--}}
...
{{--                    <a href="https://www.creative-tim.com/learning-lab/tailwind/quick-start/soft-ui-dashboard"--}}
{{--                       target="_blank"--}}
